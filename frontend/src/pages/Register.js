  ...
  <MDBRow>
    ...
    <MDBCol md='6'>
      <MDBCardBody className='d-flex flex-column'>
        ...
        <MDBInput wrapperClass='mb-4' label='Username'  type='text' size="lg" name='name' value={inputData.name} onChange={handleInputChange} />
          ...
          <MDBBtn className='mx-2' color='info' style={{width:'20%'}}>Register</MDBBtn>
        </form>
